# cfglint
Configuration file linter — no secrets, no drama
## Status
...
- Work with config, lint, security, secrets, json workflows from a local checkout.
...
```sh
git clone https://github.com/rogerchappel/cfglint.git
cd cfglint
npm install
npm run build
```
